...
export const RATE_LIMITS = {
  ...
  /** Inbound webhook receiver, per webhook id. Generous -- the caller
   *  is an automated external system (Shopify, WooCommerce, etc), not
   *  a human, so bursts of real traffic are expected. */
  inboundWebhook: { limit: 120, windowMs: 60_000 },
