...
interface DealFormProps {
  ...
  /** Pre-selects a contact for a brand-new deal (e.g. opened from that contact's own panel). Ignored when editing an existing deal. */
            ...
            {deal &&
              (confirmDelete ? (
                ...
                <button
                  ...
                  className="mt-3 flex w-full items-center justify-center gap-1 text-xs text-red-400 hover:text-red-600 dark:hover:text-red-300"
                >
